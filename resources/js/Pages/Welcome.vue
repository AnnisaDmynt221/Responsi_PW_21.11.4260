    ...
    <section cclass="bg-grey-50" id="about">
        <div class="mx-auto max-w-screen-xl container flex flex-col items-center py-16 md:py-20 lg:flex-row">
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <h4 class="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl"> I'm Annisa Damayanti.</h4>
                <p class="pt-6 font-body leading-relaxed text-grey-20"> Seorang mahasiswa dari Universitas Amikom Yogyakarta dan menggambil jurusan S1 Informatika dan sekarang sedang melakukan responsi mata kuliah Pemrograman Web </p>
