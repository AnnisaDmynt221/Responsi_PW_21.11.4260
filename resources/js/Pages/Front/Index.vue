    ...
    <nav class="bg-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                <img src="img/logo_Web.png" class="h-12 mr-3" alt=" Logo" />
            ...
            <div class="flex md:order-2">
                <div v-if="canLogin">
                    <button v-if="$page.props.auth.user" :href="route('dashboard')"
                        class="text-white bg-pink-700 hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-800">Dashboard</button>
                    <template v-else>
